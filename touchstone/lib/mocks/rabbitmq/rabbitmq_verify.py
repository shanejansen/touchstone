...
class RabbitmqVerify(Verify):
    ...
    def messages_published(self, exchange: str, routing_key: str, times: int = None) -> bool:
    ...
    def payload_published(self, exchange: str, routing_key: str, expected_payload: str) -> bool:
